    ...
    <div class="right-content">
      <ul class="ulClass">
        <li class="header-item header-link">
          <el-link v-for="item in topBtnList" :key="item.urlConfigGuid" :href="item.urlPath" class="title"><p>{{item.urlName}}</p></el-link>
        </li>
        <!-- <li class="header-item header-icon">
          <span class="iconfont icon-xiaoxi iconClass" ></span>
        </li> -->
        ...
        <li class="header-item header-username">
          <el-dropdown class="user-info-wrap cursor-pointer" trigger="click">
            ...
            <el-dropdown-menu class="headerDropdown">
              ...
              <!--<div class="userMenu-phoneNumber">-->
              <!--  <div class="UserMenu-phone">-->
              <!--    <i class="el-icon-phone"></i>-->
              <!--    <span>{{userInfo.phone}}</span>-->
              <!--  </div>-->
              <!--</div>-->
              <!--<div class="UserMenu-editBox">-->
              <!--  <p><i class="iconfont icon-fuwulianjiejiankong"></i>修改密码</p>-->
              <!--</div>-->
            </el-dropdown-menu>
          </el-dropdown>
        </li>
...
import { getUrlConfigByUrlCode } from '@/api/common'
...
const {userInfo, menuOrg, LogOut } = useUserStore()
const {tag } = useTagsStore()
const {isCollapse, SET_COLLAPSE} = useCommonStore()
...
const pageName = computed(()=>{
  const { path } = route
  const routeDate = menuOrg.find(item => item.functionUrl == path)
...
const getUrl = ()=> {
  ...
  getUrlConfigByUrlCode(params).then(res => {
    if (verifyResIsSuccess(res)) {
      topBtnList.value = res.data.data
    }
  })
}
